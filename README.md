...
기존 실험은 분석 대상 문항만으로 Word2Vec을 학습했기 때문에, 일부 희소 전문용어와 수식 표기 토큰의 의미벡터가 불안정할 수 있었습니다. 이를 보완하기 위해 본 프로젝트는 다음 구조로 재설계되었습니다.
...
이 구조는 수업에서 다룬 형태소 분석과 워드임베딩 절차를 그대로 확장하면서, 실제 한국어 LLM 벤치마크 문항의 전문어휘 분석에도 적용할 수 있도록 설계되었습니다.
